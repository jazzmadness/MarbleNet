...
with tf.Session() as sess:
	...
	for episodio in range(numero_episodios):
		...
		while not done:
			#vamos implementar um frame-skip de 4, pois nao precisamos olhar frame a frame
			...
			#2017. eprint: arXiv:1707.03141

			if passo % 4 != 0: #se nao estou num multiplo de 4
				env.step(acao_disc) #pula esses frames
				passo += 1
				continue #vai pra prox interacao
